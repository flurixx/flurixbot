...
async def start(ctx,guild,name="MUTED"):
...
!ban и !unban - бан и соответственно разбан пользователя на сервере
!tempban - временный бан пользователя на сервере
!tempmute - временная блокировка чата пользователю)
